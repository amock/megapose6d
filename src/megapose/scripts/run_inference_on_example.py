...
def make_detections_visualization(
    ...
    export_png(fig_det, filename=output_fn, webdriver=get_driver())
...
def make_output_visualization(
    ...
    export_png(fig_mesh_overlay, filename=vis_dir / "mesh_overlay.png", webdriver=get_driver())
    export_png(fig_contour_overlay, filename=vis_dir / "contour_overlay.png", webdriver=get_driver())
    export_png(fig_all, filename=vis_dir / "all_results.png", webdriver=get_driver())
